%   Repeatability_Task_Generator_6.m
...
function Repeatability_Task_Generator_6()
% Mode 0 - absolute moves; Mode 1 - relative moves

% ------------------------ User Settings ----------------------------------
outFile = 'PrintTask_6.csv';
...
z_first_mm              = -98.8;     % Z at first line
z_step_mm               = +0.0;      % increment Z per line
...
extrusion_rate_mm_s     = 0.4;       % plunger rate (mm/s)
E_per_line_override     = []; 
