...
\noindent
\begin{tabular}{@{}lllll@{}}
\tstrut Signature: & \sigfield[4cm]{figs/signature.png} &            &            \\
\tstrut Name:      & \makebox[5cm][l]{\shortstack[l]{Simon Craig Daniel \\ \dotfill}}
                   & Student no: & \makebox[3cm][l]{\shortstack[l]{25848887 \\ \dotfill}} \\
\tstrut Date:      & \makebox[4cm][l]{\shortstack[l]{24~October~2025 \\ \dotfill}} & & \\
\end{tabular}
