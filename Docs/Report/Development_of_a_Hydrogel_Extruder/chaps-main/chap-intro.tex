...
\begin{enumerate}
    ...
    \item To design and implement an embedded system, including necessary firmware, capable of real-time control of system actuators, sensing, and closed-loop logic.
    \item To experimentally tune and validate the mechatronic system through a designed calibration procedure for determining optimal printing parameters for different bioinks.
\end{enumerate}
